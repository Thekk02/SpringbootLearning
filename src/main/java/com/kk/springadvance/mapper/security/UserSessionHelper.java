package com.kk.springadvance.mapper.security;

import com.auth0.jwt.JWT;
import com.auth0.jwt.JWTVerifier;
import com.auth0.jwt.algorithms.Algorithm;
import com.auth0.jwt.interfaces.DecodedJWT;
import com.kk.springadvance.util.JsonUtil;
import com.kk.springadvance.util.RedisUtil;
import lombok.Data;
...
public class UserSessionHelper {
    @Component
    @Data
    @ConfigurationProperties("springadvance.jwt")
    ...
    public String genSession(Long userId) {
        ...
        String session = JsonUtil.toStr("u", String.valueOf(userId)));
        ...
        RedisUtil.setStrWithExpire(token, String.valueOf(userId), jwtProperties.getExpire() / 1000);
        return token;
    }
    ...
    public Long getUserIdBySession(String session) {
        ...
        try {
            ...
            String user = RedisUtil.getStr(session);
